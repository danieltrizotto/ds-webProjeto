    ...
    <body>
        <header>
            ...
            <nav class="categoriasNav">
                <a href="#">Cameras <i class="fa-solid fa-camera-retro"></i></a>
                <a href="#">Computadores <i class="fa-brands fa-windows"></i></a>
                <a href="#">Celulares <i class="fa-solid fa-mobile"></i></a>
                <a href="#">VideoGames <i class="fa-solid fa-gamepad"></i></a>
                <a href="#">TVs <i class="fa-solid fa-tv"></i></a>
                <a href="#">Caixas de som <i class="fa-solid fa-music"></i></a>
                <a href="#">Acessorios <i class="fa-solid fa-headset"></i></a>
            </nav>
        </header>
        <main>
